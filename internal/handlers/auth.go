...
func AuthCallback(c *fiber.Ctx) error {
	...
	if err == nil {
		sess.Regenerate() // Regenerate session ID to prevent session fixation
	...
	SetFlash(c, "success", "Successfully logged in via "+gothUser.Provider)
	return c.Redirect("/")
}
...
func PostLogin(c *fiber.Ctx) error {
	...
	SetFlash(c, "success", "Welcome back, "+user.Name+"!")
