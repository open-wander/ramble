...
func main() {
	...
	app.Post("/orgs/new", handlers.RequireAuth, handlers.PostCreateOrg)
	app.Get("/orgs/:orgname/settings", handlers.RequireAuth, handlers.RequireOrgOwner, handlers.GetOrgSettings)
	app.Post("/orgs/:orgname/update", handlers.RequireAuth, handlers.RequireOrgOwner, handlers.PostUpdateOrg)
	app.Post("/orgs/:orgname/members/add", handlers.RequireAuth, handlers.RequireOrgOwner, handlers.PostAddMember)
	app.Post("/orgs/:orgname/members/:member_id/remove", handlers.RequireAuth, handlers.RequireOrgOwner, handlers.PostRemoveMember)
	...
	app.Post("/new", handlers.RequireAuth, handlers.PostNewResource)
	app.Delete("/resource/:id", handlers.RequireAuth, handlers.DeleteResource)
	app.Post("/resource/:id/webhook", handlers.HandleWebhook)
	app.Post("/resource/:id/webhook/reset", handlers.RequireAuth, handlers.PostResetWebhookSecret)
	...
	app.Post("/resource/:id/version", handlers.RequireAuth, handlers.PostNewVersion)
	...
	app.Post("/resource/:id/edit", handlers.RequireAuth, handlers.PostEditResource)
